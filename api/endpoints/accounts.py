...
@router.get("/{account_id}", tags=["Accounts"], name="Read Your Account")
...
@router.post("", tags=["Accounts"], name="Create Your Account")
...
@router.put("", tags=["Accounts"], name="Update Your Account")
...
@router.delete("", tags=["Accounts"], name="Delete Your Account")
...
@router.get("", tags=["Accounts"], name="Get Your Statements")
...
@router.post("/deposit", tags=["Accounts"], name="Deposit Amount")
...
@router.post("/withdraw", tags=["Accounts"], name="Withdraw Amount")
